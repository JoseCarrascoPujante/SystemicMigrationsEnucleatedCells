function [T1,ties_factor,T2] = dunn(x,g,varargin)
...
T1 = array2table([Idx' N' R' Mr(:,1)],'VariableNames',{'Group','N','Sum_of_ranks','Mean_rank'});
disp(T1)
ties_factor = ['Ties factor: ' num2str(2*t)] ;
disp(ties_factor)
disp(' ')
...
T2 = cell2table(pb,'VariableNames',{'Comparison','Q_value','Crit_Q','Comment'}) ;
disp(T2)
